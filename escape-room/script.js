    ...
    ready() {
      ...
      new CommandMap('input', {input: 'Input'}, {
        Input(parser, name) {
          ...
          const placeholder = parser.GetArgument(name);
          xml.setXML(MathJax.startup.adaptor.node('input', {
            id: id, type: 'number', placeholder, style: {left, position: "relative", fontSize: size, width: w}, xmlns: 'http://www.w3.org/1999/xhtml'
